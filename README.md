...
✨ Technologies
- Unity (frontend / interactive UI)
- VS Code (development environment)
- Python with FastAPI (backend logic)
- OpenAI API (AI responses)

🚀 Features
- Personalized prompt per character make each interaction unique
- Speak freely and receive AI responses based on your emotions
